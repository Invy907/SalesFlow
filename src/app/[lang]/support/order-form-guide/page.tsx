...
import { getOrdersContent, getOrdersHref } from "../../orders/content";
import { getSupportHref } from "../content";

const backToSupportLabel = { ja: "サポートに戻る", ko: "지원으로 돌아가기", en: "Back to Support" } as const;
...
export default function OrderFormGuidePage() {
  ...
  return (
    <SalesFlowShell activeItem="support">
      <div className="mx-auto w-full max-w-[1260px] px-4 py-6 pb-12 sm:px-6 sm:py-8 sm:pb-14 lg:px-8 lg:py-10 lg:pb-16">
        ...
        >
          ← {backToSupportLabel[lang as keyof typeof backToSupportLabel] ?? backToSupportLabel.ja}
        </Link>
