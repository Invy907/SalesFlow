          ...
          <BulkSection title={bulk.uploadSection}>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-4">
              <button
                ...
                className="rounded bg-[#0A4D34] px-8 py-3 text-[15px] font-semibold text-white transition hover:bg-[#083D29] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:hover:bg-slate-300"
              >
                {bulk.upload}
              </button>
              {message ? (
