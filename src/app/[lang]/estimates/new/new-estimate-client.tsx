        ...
        {activeTab === "basic" && (
          <>
            <div className="mt-10 grid gap-8 xl:grid-cols-2">
              <section>
                <SectionTitle title={ui.estimateInfo} />
            ...
            <DocumentLineItemsTable ui={ui} storageKey="estimate-new-line-items" onTotalsChange={setLineItemTotals} />
            <RemarksField ui={ui} />
          </>
        )}
...
function RemarksField({ ui }: { ui: ReturnType<typeof getEstimateContent> }) {
  return (
    <div className="mt-12">
      <label className="mb-2 block text-[18px] font-semibold text-slate-800">{ui.remarks}</label>
      <textarea className="field min-h-[140px]" />
